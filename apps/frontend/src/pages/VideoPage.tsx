...
export function VideoPage() {
    ...
    const templateSrc = searchParams.get("template");
    const [view, setView] = useState<View>(templateSrc ? "intro" : "intro");
            ...
            <div className="flex flex-col gap-4 lg:flex-row">
                ...
                <main className="min-h-[60vh] flex-1 overflow-hidden rounded-2xl border border-white/[0.08] bg-card/40">
                    {view === "library" ? (
                        ...
                        <div className="p-6">
                            <div className="mb-4 rounded-xl border border-primary/30 bg-primary/[0.06] p-4">
                                <h3 className="flex items-center gap-2 text-sm font-bold text-primary">
                                    <Sparkles className="h-4 w-4" />
                                    Template loaded — describe your edits in the prompt
                                </h3>
                                <p className="mt-1 text-xs text-muted-foreground">
                                    Your template video is shown below. Use the form on the left to describe
                                    what you want to change — AI will generate a new version based on your prompt.
                                </p>
                            </div>
                            <video
                                src={templateSrc}
